...
<body>
    ...
    <main class="container mt-5 mb-5">
        <div class="row">
            <div class="col-sm">
                <h3 class="text-center text-uppercase fw-bold">Sửa thông tin câu hỏi</h3>
                <form action="index.php?controller=question&action=update" method="post">
                <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatId">ID</span>
                        <input type="text" class="form-control" name="id" readonly value="<?= $question["id"]  ?>">
                    </div>
                    <div class="input-group mt-3 mb-3">
                    ...
                    <div class="form-group  float-end ">
                        ...
                        <a href="index.php?controller=question&action=index" class="btn btn-warning ">Quay lại</a>
                    </div>
                </form>
            </div>
        </div>
