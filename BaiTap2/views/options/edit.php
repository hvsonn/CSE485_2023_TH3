        ...
        <div class="row">
            <div class="col-sm">
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Option Text</span>
                        <input type="text" class="form-control" name="option_text" value = "<?= $option["option_text"]  ?>">
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Is Correct</span>
                        <input type="text" class="form-control" name="is_correct" value = "<?= $option["is_correct"]  ?>">
                    </div>
